...
//  console.log(key);
  ...
  let val = `https://quote-api.jup.ag/v6/quote?inputMint=${inputToken}&outputMint=${outputToken}&amount=${amount}&slippageBps=${(slippage*100).toFixed(0)}`;
...
function startWorker(){
  ...
  for (let i = 0; i < 5; i++) {
    ...
    const worker = new Worker("./worker.js", { workerData: {t1 : transactions[localCounter],
